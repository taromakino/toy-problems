...
def make_model(args, task, eval_stage):
    ...
    if task == Task.ERM:
        ...
        return VAE(task, args.z_size, args.rank, args.h_sizes, args.y_mult, args.beta, args.prior_reg_mult,
            args.init_sd, args.lr, args.weight_decay, args.kl_anneal_ratio, args.lr_infer, args.n_infer_steps)
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--kl_anneal_ratio', type=float, default=0.1)
