...
class Encoder(nn.Module):
    def __init__(self, causal_size, spurious_size, h_sizes):
        ...
        self.low_rank_causal = SkipMLP(IMG_ENCODE_SIZE + N_ENVS, h_sizes, causal_size ** 2)
        ...
        self.low_rank_spurious = SkipMLP(IMG_ENCODE_SIZE + N_CLASSES + N_ENVS, h_sizes, spurious_size ** 2)
    ...
    def causal_dist(self, x, e):
        ...
        low_rank = low_rank.reshape(batch_size, self.causal_size, self.causal_size)
    ...
    def spurious_dist(self, x, y, e):
        ...
        low_rank = low_rank.reshape(batch_size, self.spurious_size, self.spurious_size)
...
class Prior(nn.Module):
    def __init__(self, causal_size, spurious_size, init_sd):
        ...
        self.low_rank_causal = nn.Parameter(torch.zeros(causal_size, causal_size))
        ...
        self.low_rank_spurious = nn.Parameter(torch.zeros(N_CLASSES, N_ENVS, spurious_size, spurious_size))
    ...
    def causal_dist(self, batch_size):
        ...
        low_rank = repeat_batch(self.low_rank_causal, batch_size)
