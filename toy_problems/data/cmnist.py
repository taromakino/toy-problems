...
def make_data(train_ratio, batch_size, eval_batch_size, n_test_examples):
    ...
    if n_test_examples is not None:
        x_test, y_test, e_test, c_test, s_test = subsample(x_test, y_test, e_test, c_test, s_test, n_test_examples)
